...
public class Gasto extends Domain {
	...
	private Set<CtaCteEmpresaMovimiento> aplicacionesDebitoBancario = new HashSet<CtaCteEmpresaMovimiento>();
	...
	public Set<CtaCteEmpresaMovimiento> getAplicacionesDebitoBancario() {
		return aplicacionesDebitoBancario;
	}

	public void setAplicacionesDebitoBancario(
			Set<CtaCteEmpresaMovimiento> aplicacionesDebitoBancario) {
