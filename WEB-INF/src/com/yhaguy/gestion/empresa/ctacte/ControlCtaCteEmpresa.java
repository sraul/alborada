...
public class ControlCtaCteEmpresa extends Control {
	...
	/**
	 * Recupera una lista de los movimientos pendientes(Saldos Positivos)
	 * 
	 * @param empresa
	 *            Empresa de la cual se quieren recuperar sus movimientos
	 *            Pendientes
	 * @param caracterMovimientos
	 *            El caracter de los movimientos de la empresa(Como cliente o
	 *            como proveedor)
	 * @return Una lista con los movimientos pendientes de esa empresa(Saldo
	 *         positivo) o una lista vacia en caso de que no tenga movimientos
	 *         pendientes.
	 * @throws Exception
	 */
	public List<CtaCteEmpresaMovimientoDTO> getCtaCteEmpresaMovimientosPendientes(IiD empresa,
			MyPair caracterMovimientos) throws Exception {

		Tipo caracter = movimientoAss.MyPairToTipo(caracterMovimientos);
		List<CtaCteEmpresaMovimiento> movimientosPendientesDom = rr.getMovimientosPendientes(empresa, caracter);
