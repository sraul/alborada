...
public class NotaCreditoAssembler extends Assembler {
	...
	static String[] attTipoMovimiento = { "descripcion", "sigla", "clase",
			"tipoIva" };
	static String[] attEmpresa = { "codigoEmpresa", "razonSocial", "ruc",
			"idEmpresa", "direccion", "telefono" };
	...
	public DTO domainToDto(Domain domain) throws Exception {
		NotaCreditoDTO dto = (NotaCreditoDTO) getDTO(domain,
...
class NotaCreditoDetalleAssembler extends Assembler {
	...
	static final String[] ATT_IGUALES = { "cantidad", "costoGs", "montoGs", "montoDs",
			"importeGs", "importeDs" };
	static final String[] ATT_VENTA = { "descripcionTipoMovimiento", "numero",
			"fecha", "tipoMovimiento", "siglaTipoMovimiento", "descripcionCondicion" };	
	static final String[] ATT_COMPRA = { "descripcionTipoMovimiento", "numero",
			"fechaCreacion", "tipoMovimiento" };
	static final String[] ATT_ARTICULO = { "descripcion", "codigoInterno" };
	static final String[] ATT_GASTO = { "descripcionTipoMovimiento", "numeroFactura",
