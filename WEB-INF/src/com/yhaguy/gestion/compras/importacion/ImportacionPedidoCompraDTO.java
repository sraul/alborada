...
public class ImportacionPedidoCompraDTO extends DTO{
	...
	private int propietarioActual = 1; // 1:Importacion - 2:Ventas - 3:Administracion
	...
	public void setResumenGastosDespacho(
			ResumenGastosDespachoDTO resumenGastosDespacho) {
	...
	public String getPropietario(){
		...
		case 1: out=Configuracion.PROPIETARIO_IMPORTACION_DESCRIPCION;			
			break;
		case 2: out=Configuracion.PROPIETARIO_VENTAS_DESCRIPCION;
			break;
		case 3: out=Configuracion.PROPIETARIO_ADMINISTRACION_DESCRIPCION;
			break;
		}
	...
	public void setGastosImprevistos(
			List<ImportacionGastoImprevistoDTO> gastosImprevistos) {
