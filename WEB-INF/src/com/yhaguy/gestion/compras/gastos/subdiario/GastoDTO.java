...
public class GastoDTO extends DTO{
	...
	private List<MyArray> aplicacionesDebitoBancario = new ArrayList<MyArray>();
	...
	@DependsOn("aplicacionesDebitoBancario")
	public double getTotalAplicacionesDebitoBancario() {
		double out = 0;
		for (MyArray det : this.aplicacionesDebitoBancario) {
			out = out + (double) det.getPos3();
		}
		return out;
	}
	...
	public List<MyArray> getAplicacionesDebitoBancario() {
		return aplicacionesDebitoBancario;
	}

	public void setAplicacionesDebitoBancario(
			List<MyArray> aplicacionesDebitoBancario) {
		this.aplicacionesDebitoBancario = aplicacionesDebitoBancario;
	}
