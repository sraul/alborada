...
public class OrdenPedidoGastoControlBody extends BodyApp {
	...
	@Command
	@NotifyChange("*")
	public void addAplicacionDebitoBancario(@BindingParam("comp") Bandbox comp) {
		this.dtoGasto.getAplicacionesDebitoBancario().add(this.selectedAplicacionDebitoBancario);
		comp.close();
	}
	...
	private void generarDebitoBancario(GastoDTO gasto) 
		...
		ControlCuentaCorriente.cancelarSaldoConDebitoBancario(gasto.getId(), this.getLoginNombre());
	}
