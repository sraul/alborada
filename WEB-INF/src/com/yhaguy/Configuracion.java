...
public class Configuracion extends Config {
	...
	public static String pathDebitosComandados = PATH_SESSION + ("/yhaguy/archivos/debitos_comandados/") + "/";
	...
	static {
		try {
			...
			pathBarcodes = Sessions.getCurrent().getWebApp()
					...
					+ "/";
			pathDebitosComandados = Sessions.getCurrent().getWebApp()
					.getRealPath("/yhaguy/archivos/debitos_comandados/")
					+ "/";
	...
	public static final int LIMITE_ITEMS_FACTURA_VENTA = 11;
	...
	public static final String ID_TIPO_MONEDA_GUARANI = "Guarani";
	public static final String ID_TIPO_MONEDA_DOLAR = "Dolar";
	...
	public static String SIMBOLO_DOLAR = "U$S";
	public static String SIMBOLO_PORCENTAJE = "%";
	public static String SIMBOLO_GUION_MEDIO = "-";
	public static String SIMBOLO_ASTERISCO = "(*)";
	public static String FORMATO_DOLAR = "#,##0.00";
	public static String FORMATO_GUARANIES = "#,##0";
	...
	public final static String SIGLA_TM_CONTRATO_SERVICIO_ODONTOLOGIA = "MOV-CON-SER-ODO";
